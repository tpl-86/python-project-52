...
class TaskCRUDTest(TestCase):
    ...
    def test_task_update(self):
        ...
        response = self.client.post(
            reverse("tasks:task_update", kwargs={"pk": self.task.pk}), data
        )
        self.assertRedirects(response, reverse("tasks:task_list"))
    ...
    def test_task_delete_by_author(self):
        ...
        response = self.client.post(
            reverse("tasks:task_delete", kwargs={"pk": new_task.pk})
        )
        self.assertRedirects(response, reverse("tasks:task_list"))
...
class TaskFilterTest(TestCase):
    ...
    def test_filter_by_executor(self):
        ...
        response = self.client.get(
            reverse("tasks:task_list"), {"executor": self.other_user.pk}
        )
    ...
    def test_filter_by_label(self):
        ...
        response = self.client.get(
            reverse("tasks:task_list"), {"labels": label.pk}
        )
        self.assertContains(response, "Тестовая задача")
